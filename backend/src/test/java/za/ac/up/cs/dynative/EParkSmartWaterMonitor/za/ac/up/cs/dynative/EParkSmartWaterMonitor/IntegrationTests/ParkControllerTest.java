...
public class ParkControllerTest {
    ...
    public void getParkWaterSitesIdNull(){
        ...
        ResponseEntity<GetParkSitesResponse> response = restTemplate.withBasicAuth("testingOne", "test1")
    ...
    public void getParkWaterSites(){
        GetParkSitesRequest request = new GetParkSitesRequest(UUID.fromString("8f38a427-a5b6-4552-af52-920ae090a012"));
        ResponseEntity<GetParkSitesResponse> response = restTemplate.withBasicAuth("testingOne", "test1")
                .postForEntity("/api/park/getParkWaterSites",request,GetParkSitesResponse.class);
        assertEquals(HttpStatus.OK, response.getStatusCode());
    ...
    public void getAllParksAndSites(){
        ResponseEntity<GetAllParksAndSitesResponse> response = restTemplate.withBasicAuth("testingOne", "test1")
    ...
    public void getAllParks(){
        ResponseEntity<GetAllParksResponse> response = restTemplate.withBasicAuth("testingOne", "test1")
...
//        ResponseEntity<EditParkResponse> response = restTemplate.withBasicAuth("testingOne", "test1")
...
//        EditParkRequest request = new EditParkRequest(UUID.fromString("8f38a427-a5b6-4552-af52-920ae090a012"),"Kruger","","");
//        ResponseEntity<EditParkResponse> response = restTemplate.withBasicAuth("testingOne", "test1")
//                .postForEntity("/api/park/editPark",request,EditParkResponse.class);
//        assertEquals(HttpStatus.OK, response.getStatusCode());
...
//        assertEquals(true, response.getBody().getSuccess());
//
//        request = new EditParkRequest(UUID.fromString("8f38a427-a5b6-4552-af52-920ae090a012"),"Kruger National Park","","");
...
//        assertEquals(true, response.getBody().getSuccess());
    ...
    public void AddParkIncomplete() {
        ...
        ResponseEntity<CreateParkResponse> response = restTemplate.withBasicAuth("testingOne", "test1")
    ...
    public void AddPark() {
        ...
        ResponseEntity<DeleteParkResponse> responsee = restTemplate.withBasicAuth("testingOne", "test1")
